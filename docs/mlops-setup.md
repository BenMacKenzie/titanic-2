...
[ML Config](../titanic_2/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore titanic_2/resources/README.md
...
Follow the instructions in [titanic-2/resources/README.md](../titanic_2/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../titanic_2/resources/README.md)  to propose, test, and deploy
