...
Opening a pull request will trigger a[workflow](../.github/workflows/titanic-2-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/staging-titanic-2-model)
* [Prod workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/prod-titanic-2-model)
