# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [titanic_2/resources/README.md](../../resources/README.md)
...
df.write.mode("overwrite").saveAsTable(
    name="<catalog>.titanic-2.feature_store_inference_input"
)
```
